...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Rerolls', path: '/rerolls', entity: 'reroll', service: AccessServiceEnum.PROJECT, icon: FiRefreshCw },
    { name: 'Todos', path: '/todos', entity: 'todo', service: AccessServiceEnum.PROJECT, icon: FiClipboard },

...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Daily todo hyperlink`}</title>

        <meta
          name="description"
          content="Experience seamless organization with Daily todo hyperlink - Your daily tasks, now with hyperlinks, for a more efficient and productive day. Enjoy the freedom to reroll thrice daily."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0b2RvJTIwbGlzdHxlbnwwfHx8fDE2OTAyMjM1NzZ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Daily todo hyperlink`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless organization with Daily todo hyperlink - Your daily tasks, now with hyperlinks, for a more efficient and productive day. Enjoy the freedom to reroll thrice daily.`}
            </Text>
            <Box
